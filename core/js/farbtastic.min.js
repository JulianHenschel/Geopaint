$(document).ready(function(){$("#picker").farbtastic("#selectedcolor")});jQuery.fn.farbtastic=function(g){$.farbtastic(this,g);return this};jQuery.farbtastic=function(g,l){g=$(g).get(0);return g.farbtastic||(g.farbtastic=new jQuery._farbtastic(g,l))};
